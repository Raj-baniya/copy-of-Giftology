                                ...
                                <div className="mt-auto space-y-6">
                                    <div className="flex gap-4">
                                        <button
                                            ...
                                            className={`flex-1 py-4 px-8 rounded-full font-bold text-lg flex items-center justify-center gap-3 transition-all transform ${!product.stock || product.stock <= 0
                                                ? 'bg-gray-300 text-gray-500 cursor-not-allowed'
                                                : 'bg-gradient-to-r from-rose-400 to-rose-600 text-white hover:shadow-lg hover:shadow-rose-200 hover:-translate-y-1'
                                                }`}
                                        >
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-6">
                                        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                            <div className={`p-2 bg-white rounded-full shadow-sm ${!product.stock || product.stock <= 0 ? 'text-red-600' : 'text-green-600'}`}>
                                                {(!product.stock || product.stock <= 0) ? <Icons.X className="w-5 h-5" /> : <Icons.Check className="w-5 h-5" />}
                                            </div>
                                            <div className="flex flex-col">
                                                ...
                                                {product.stock && product.stock > 0 && product.stock < 10 && (
                                                    <span className="text-xs text-orange-500 font-bold">Only {product.stock} left!</span>
                                                )}
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
