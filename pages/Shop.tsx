...
export const Shop = () => {
  ...
  const categoriesList = [
    ...
    { id: 'trending', name: 'Trending Now', slug: 'trending' }, // Added manually for list
    ...CATEGORIES
  ];
                            ...
                            <div className="p-3 md:p-5 flex flex-col flex-1">
                                ...
                                <div className="flex flex-col md:flex-row md:items-end justify-between mt-3 gap-2">
                                    ...
                                    <button 
                                        ...
                                        className="w-full md:w-auto bg-[#E94E77] text-white px-3 py-2 md:px-4 md:py-2 rounded-md text-xs md:text-sm font-bold active:bg-[#D63D65] transition-colors flex items-center justify-center gap-1.5"
                                    >
