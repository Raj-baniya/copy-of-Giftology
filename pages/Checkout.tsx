              ...
              <React.Fragment key={step}>
                <div className={`flex items-center gap-2 ${index <= currentStep ? 'text-primary' : 'text-gray-300'}`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm border-2 ${
                    index <= currentStep ? 'border-primary bg-primary/10' : 'border-gray-300'
                  }`}>
                    {index + 1}
                  </div>
                        ...
                        {paymentMethod === 'upi' && (
                            ...
                            >
                                <div className="bg-white p-4 rounded-xl border-2 border-gray-100 shadow-sm flex flex-col items-center">
                                    ...
                                    */}
                                    <img 
                                        src="https://api.qrserver.com/v1/create-qr-code/?size=220x220&data=upi://pay?pa=giftology@okaxis&pn=Giftology&cu=INR"
                                        alt="UPI QR Code" 
